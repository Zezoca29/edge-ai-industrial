...
CREATE TABLE IF NOT EXISTS products (
    ...
    name             TEXT NOT NULL,
    sku              TEXT,
    unit_weight_g    DOUBLE PRECISION NOT NULL CHECK (unit_weight_g > 0),
    tolerance_g      DOUBLE PRECISION NOT NULL DEFAULT 5,
...
CREATE TABLE IF NOT EXISTS shelf_slots (
    ...
    tare_g           DOUBLE PRECISION NOT NULL DEFAULT 0,
    min_qty          INT NOT NULL DEFAULT 3,
    current_qty      INT,
    current_weight_g DOUBLE PRECISION,
